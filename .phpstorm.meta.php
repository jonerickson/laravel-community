...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/jonerickson/Code/mi/public/storage' => 'string',
            ...
            'services.roblox.client_id' => 'NULL',
            'services.roblox.client_secret' => 'NULL',
            'services.roblox.redirect' => 'string',
...
'database.redis.cache.port','database.redis.cache.database','filament-shield.shield_resource.should_register_navigation','filament-shield.shield_resource.slug','filament-shield.shield_resource.navigation_sort',
'filament-shield.shield_resource.navigation_badge','filament-shield.shield_resource.navigation_group','filament-shield.shield_resource.sub_navigation_position','filament-shield.shield_resource.is_globally_searchable','filament-shield.shield_resource.show_model_path',
'filament-shield.shield_resource.is_scoped_to_tenant','filament-shield.shield_resource.cluster','filament-shield.tenant_model','filament-shield.auth_provider_model.fqcn','filament-shield.super_admin.enabled',
'filament-shield.super_admin.name','filament-shield.super_admin.define_via_gate','filament-shield.super_admin.intercept_gate','filament-shield.panel_user.enabled','filament-shield.panel_user.name',
'filament-shield.permission_prefixes.resource','filament-shield.permission_prefixes.page','filament-shield.permission_prefixes.widget','filament-shield.entities.pages','filament-shield.entities.widgets',
'filament-shield.entities.resources','filament-shield.entities.custom_permissions','filament-shield.generator.option','filament-shield.generator.policy_directory','filament-shield.generator.policy_namespace',
'filament-shield.exclude.enabled','filament-shield.exclude.pages','filament-shield.exclude.widgets','filament-shield.exclude.resources','filament-shield.discovery.discover_all_resources',
'filament-shield.discovery.discover_all_widgets','filament-shield.discovery.discover_all_pages','filament-shield.register_role_policy.enabled','filesystems.default','filesystems.disks.local.driver',
...
'filesystems.links./Users/jonerickson/Code/mi/public/storage','inertia.ssr.enabled','inertia.ssr.url','inertia.ensure_pages_exist','inertia.page_paths',
...
'scout.typesense.model-settings','services.postmark.token','services.resend.key','services.ses.key','services.ses.secret',
'services.ses.region','services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.discord.client_id','services.discord.client_secret',
'services.discord.redirect','services.roblox.client_id','services.roblox.client_secret','services.roblox.redirect','services.workos.client_id',
'services.workos.secret','services.workos.redirect_url','session.driver','session.lifetime','session.expire_on_close',
...
'cors.exposed_headers','cors.max_age','cors.supports_credentials','blade-heroicons.prefix','blade-heroicons.fallback',
...
'filament.admin.resources.announcements.create','filament.admin.resources.announcements.view','filament.admin.resources.announcements.edit','filament.admin.resources.api-tokens.index','filament.admin.resources.api-tokens.create',
'filament.admin.resources.api-tokens.edit','filament.admin.resources.forums.index','filament.admin.resources.forums.create','filament.admin.resources.forums.edit','filament.admin.resources.groups.index',
'filament.admin.resources.groups.create','filament.admin.resources.groups.edit','filament.admin.resources.policy-categories.index','filament.admin.resources.policy-categories.create','filament.admin.resources.policy-categories.edit',
'filament.admin.resources.policies.index','filament.admin.resources.policies.create','filament.admin.resources.policies.edit','filament.admin.resources.posts.index','filament.admin.resources.posts.create',
'filament.admin.resources.posts.edit','filament.admin.resources.product-categories.index','filament.admin.resources.product-categories.create','filament.admin.resources.product-categories.edit','filament.admin.resources.products.index',
'filament.admin.resources.products.create','filament.admin.resources.products.edit','filament.admin.resources.topics.index','filament.admin.resources.topics.create','filament.admin.resources.topics.edit',
'filament.admin.resources.user-fingerprints.index','filament.admin.resources.users.index','filament.admin.resources.users.create','filament.admin.resources.users.edit','filament.admin.resources.shield.roles.index',
'filament.admin.resources.shield.roles.create','filament.admin.resources.shield.roles.view','filament.admin.resources.shield.roles.edit','filament.marketplace.auth.logout','filament.marketplace.pages.dashboard',
'cashier.payment','cashier.webhook','sanctum.csrf-cookie','livewire.update','livewire.upload-file','livewire.preview-file','api.cart.store','api.cart.update',
'api.cart.destroy','api.checkout','api.comments.store','api.fingerprint','api.like',
'api.read','api.search','home','banned',
'dashboard','register','login',
'password.request','password.email','password.reset','password.store','oauth.redirect',
'oauth.callback','verification.notice','verification.verify','verification.send','password.confirm','logout','blog.index','blog.show','blog.comments.store',
'forums.index','forums.show','forums.topics.show','forums.topics.create','forums.topics.store',
'forums.topics.reply','policies.index','policies.categories.show','policies.show','settings',
'settings.profile.edit','settings.profile.update','settings.profile.destroy','settings.appearance','settings.billing',
'settings.invoices','settings.payment-methods','store.index','store.categories.show','store.categories.products.show',
'store.products.show','store.subscriptions','store.cart.index','store.cart.destroy','store.checkout.success',
'store.checkout.cancel','storage.local',);
        registerArgumentsSet('views', 
'app','errors.banned','filament.admin.pages.dashboard','filament.components.head','filament.components.logo',
'vendor.spark.app','vendor.spark.mail.confirm_payment','vendor.spark.mail.invoice','cashier::invoice','cashier::payment',
...
'filament-panels::resources.pages.view-record','filament-panels::resources.relation-manager','filament-panels::widgets.account-widget','filament-panels::widgets.filament-info-widget','filament-shield::forms.shield-toggle',
...
'validation.url','validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','en.0',
'filament-shield::filament-shield.column.name','filament-shield::filament-shield.column.guard_name','filament-shield::filament-shield.column.team','filament-shield::filament-shield.column.roles','filament-shield::filament-shield.column.permissions',
'filament-shield::filament-shield.column.updated_at','filament-shield::filament-shield.field.name','filament-shield::filament-shield.field.guard_name','filament-shield::filament-shield.field.permissions','filament-shield::filament-shield.field.team',
'filament-shield::filament-shield.field.team.placeholder','filament-shield::filament-shield.field.select_all.name','filament-shield::filament-shield.field.select_all.message','filament-shield::filament-shield.nav.group','filament-shield::filament-shield.nav.role.label',
'filament-shield::filament-shield.nav.role.icon','filament-shield::filament-shield.resource.label.role','filament-shield::filament-shield.resource.label.roles','filament-shield::filament-shield.section','filament-shield::filament-shield.resources',
'filament-shield::filament-shield.widgets','filament-shield::filament-shield.pages','filament-shield::filament-shield.custom','filament-shield::filament-shield.forbidden','filament-shield::filament-shield.resource_permission_prefixes_labels.view',
'filament-shield::filament-shield.resource_permission_prefixes_labels.view_any','filament-shield::filament-shield.resource_permission_prefixes_labels.create','filament-shield::filament-shield.resource_permission_prefixes_labels.update','filament-shield::filament-shield.resource_permission_prefixes_labels.delete','filament-shield::filament-shield.resource_permission_prefixes_labels.delete_any',
'filament-shield::filament-shield.resource_permission_prefixes_labels.force_delete','filament-shield::filament-shield.resource_permission_prefixes_labels.force_delete_any','filament-shield::filament-shield.resource_permission_prefixes_labels.restore','filament-shield::filament-shield.resource_permission_prefixes_labels.reorder','filament-shield::filament-shield.resource_permission_prefixes_labels.restore_any',
'filament-shield::filament-shield.resource_permission_prefixes_labels.replicate','filament-actions::associate.single.label','filament-actions::associate.single.modal.heading','filament-actions::associate.single.modal.fields.record_id.label','filament-actions::associate.single.modal.actions.associate.label',
...
'CASHIER_CURRENCY','CASHIER_CURRENCY_LOCALE','CACHE_STORE','DB_CONNECTION','DB_HOST',
'DB_PORT','DB_DATABASE','DB_USERNAME','DB_PASSWORD','LOG_CHANNEL',
'LOG_STACK','LOG_DEPRECATIONS_CHANNEL','LOG_LEVEL','BROADCAST_CONNECTION','FILESYSTEM_DISK',
'QUEUE_CONNECTION','SCOUT_DRIVER','MAIL_MAILER','MAIL_SCHEME','MAIL_HOST',
...
'STRIPE_KEY','STRIPE_SECRET','STRIPE_WEBHOOK_SECRET','STRIPE_PRODUCT_1','STRIPE_PRODUCT_1_PRICE_1',
'STRIPE_PRODUCT_1_PRICE_2','STRIPE_PRODUCT_2','STRIPE_PRODUCT_2_PRICE_1','STRIPE_PRODUCT_2_PRICE_2','STRIPE_SUBSCRIPTION_1_PRICE_1',
'STRIPE_SUBSCRIPTION_1_PRICE_2','PHP_CLI_SERVER_WORKERS','VITE_APP_NAME',);
