    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'Spark\Contracts\Actions\CalculatesVatRate' => \Spark\Actions\CalculateVatRate::class,
            'Spark\Contracts\Actions\CreatesSubscriptions' => \Spark\Actions\CreateSubscription::class,
            'Spark\Contracts\Actions\PaysInvoices' => \Spark\Actions\PayInvoice::class,
            'Spark\Contracts\Actions\UpdatesSubscriptions' => \Spark\Actions\UpdateSubscription::class,
            ...
            'spark.manager' => \Spark\SparkManager::class,
            'translation.loader' => \Illuminate\Translation\FileLoader::class,
            'translator' => \Illuminate\Translation\Translator::class,
            'url' => \Illuminate\Routing\UrlGenerator::class,
            'validation.presence' => \Illuminate\Validation\DatabasePresenceVerifier::class,
            'vatcalculator' => \Mpociot\VatCalculator\VatCalculator::class,
    ...
    override(\config(), map([
            ...
            'spark.path' => 'string',
            'spark.middleware' => 'array',
            'spark.prorates' => 'boolean',
            'spark.date_format' => 'string',
            'spark.features' => 'array',
            'spark.invoice_data.vendor' => 'string',
            'spark.invoice_data.product' => 'string',
            'spark.invoice_data.street' => 'string',
            'spark.invoice_data.location' => 'string',
            'spark.invoice_data.phone' => 'string',
            'spark.billables.user.model' => 'string',
            'spark.billables.user.trial_days' => 'integer',
            'spark.billables.user.default_interval' => 'string',
            'spark.billables.user.plans' => 'array',
            'spark.brand.logo' => 'string',
            'spark.brand.color' => 'string',
            ...
            'vat_calculator.rules' => 'array',
            'vat_calculator.business_country_code' => 'string',
            'vat_calculator.forward_soap_faults' => 'boolean',
            'vat_calculator.soap_timeout' => 'integer',
            'vat_calculator.hmrc.client_id' => 'NULL',
            'vat_calculator.hmrc.client_secret' => 'NULL',
        ]));
...
'cashier.invoices.renderer','cashier.invoices.options.paper','cashier.invoices.options.remote_enabled','cashier.logger','database.default',
...
'database.redis.cache.password','database.redis.cache.port','database.redis.cache.database','filament-shield.shield_resource.should_register_navigation','filament-shield.shield_resource.slug',
...
'filesystems.disks.s3.report','filesystems.links./Users/jonerickson/Code/mi/public/storage','inertia.ssr.enabled','inertia.ssr.url','inertia.testing.ensure_pages_exist',
...
'services.slack.notifications.channel','services.discord.client_id','services.discord.client_secret','services.discord.redirect','services.roblox.client_id',
'services.roblox.client_secret','services.roblox.redirect','services.workos.client_id','services.workos.secret','services.workos.redirect_url',
...
'session.partitioned','spark.path','spark.middleware','spark.prorates','spark.date_format',
'spark.features','spark.invoice_data.vendor','spark.invoice_data.product','spark.invoice_data.street','spark.invoice_data.location',
'spark.invoice_data.phone','spark.billables.user.model','spark.billables.user.trial_days','spark.billables.user.default_interval','spark.billables.user.plans',
'spark.brand.logo','spark.brand.color','hashing.driver','hashing.bcrypt.rounds','hashing.bcrypt.verify',
...
'cors.max_age','cors.supports_credentials','blade-heroicons.prefix','blade-heroicons.fallback','blade-heroicons.class',
...
'filament.cache_path','filament.livewire_loading_delay','filament.system_route_prefix','livewire.class_namespace','livewire.view_path',
...
'tinker.commands','tinker.alias','tinker.dont_alias','vat_calculator.rules','vat_calculator.business_country_code',
'vat_calculator.forward_soap_faults','vat_calculator.soap_timeout','vat_calculator.hmrc.client_id','vat_calculator.hmrc.client_secret',);
        registerArgumentsSet('middleware', 
'web','api','auth','auth.basic','auth.session',
'cache.headers','can','guest','password.confirm','precognitive',
'signed','throttle','verified','subscribed',);
...
'filament.admin.resources.announcements.create','filament.admin.resources.announcements.view','filament.admin.resources.announcements.edit','filament.admin.resources.product-categories.index','filament.admin.resources.product-categories.create',
'filament.admin.resources.product-categories.edit','filament.admin.resources.products.index','filament.admin.resources.products.create','filament.admin.resources.products.edit','filament.admin.resources.shield.roles.index',
...
'cashier.payment','cashier.webhook','spark.invoices.download','spark.portal','livewire.update','livewire.upload-file','livewire.preview-file','home',
'dashboard','news.index','profile.edit','profile.update',
'profile.destroy','profile.billing','profile.invoices','profile.payment-methods','appearance',
'store.categories','store.products.view','store.subscriptions','register',
...
'app','filament.admin.pages.dashboard','filament.components.logo','spark::app','spark::mail.confirm_payment',
'spark::mail.invoice','vendor.spark.app','vendor.spark.mail.confirm_payment','vendor.spark.mail.invoice','cashier::invoice',
'cashier::payment','filament-actions::badge-action','filament-actions::badge-group','filament-actions::button-action','filament-actions::button-group',
...
'filament-shield::forms.shield-toggle','filament-tables::columns.checkbox-column','filament-tables::columns.color-column','filament-tables::columns.icon-column','filament-tables::columns.image-column',
...
'spark::app','spark::mail.confirm_payment','spark::mail.invoice',);
...
'QUEUE_CONNECTION','MAIL_MAILER','MAIL_SCHEME','MAIL_HOST','MAIL_PORT',
'MAIL_USERNAME','MAIL_PASSWORD','MAIL_FROM_ADDRESS','MAIL_FROM_NAME','MEMCACHED_HOST',
'REDIS_CLIENT','REDIS_HOST','REDIS_PASSWORD','REDIS_PORT','SESSION_DRIVER',
'SESSION_LIFETIME','SESSION_ENCRYPT','SESSION_PATH','SESSION_DOMAIN','STRIPE_KEY',
'STRIPE_SECRET','STRIPE_WEBHOOK_SECRET','PHP_CLI_SERVER_WORKERS','VITE_APP_NAME',);
