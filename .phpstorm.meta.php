...
'filament.admin.resources.posts.create','filament.admin.resources.posts.edit','filament.admin.resources.product-categories.index','filament.admin.resources.product-categories.create','filament.admin.resources.product-categories.edit',
'filament.admin.resources.products.index','filament.admin.resources.products.create','filament.admin.resources.products.edit','filament.admin.resources.topics.index','filament.admin.resources.topics.create',
'filament.admin.resources.topics.edit','filament.admin.resources.user-fingerprints.index','filament.admin.resources.user-fingerprints.create','filament.admin.resources.user-fingerprints.edit','filament.admin.resources.users.index',
'filament.admin.resources.users.create','filament.admin.resources.users.edit','filament.admin.resources.shield.roles.index','filament.admin.resources.shield.roles.create','filament.admin.resources.shield.roles.view',
'filament.admin.resources.shield.roles.edit','filament.marketplace.auth.logout','filament.marketplace.pages.dashboard','cashier.payment','cashier.webhook',
'sanctum.csrf-cookie','livewire.update','livewire.upload-file',
'livewire.preview-file','fingerprint','search','home',
'forums.index','forums.show','forums.topics.show','policies.index','policies.categories.show',
'policies.show','banned','dashboard','blog.index','blog.show',
'blog.comments.store','forums.topics.create','forums.topics.store','forums.topics.reply','forums.topics.read',
'posts.like','comments.like','profile.edit','profile.update',
'profile.destroy','profile.billing','profile.invoices','profile.payment-methods','appearance',
'store.categories','store.categories.show','store.products.show','store.subscriptions','store.cart',
'store.cart.store','store.cart.update','store.cart.delete','store.cart.clear','store.cart.checkout',
'store.checkout.success','store.checkout.cancel','register','login','password.request','password.email','password.reset','password.store',
