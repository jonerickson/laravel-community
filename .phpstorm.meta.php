...
'filament.exports.download','filament.imports.failed-rows.download','filament.admin.auth.logout','filament.admin.pages.dashboard','filament.admin.resources.product-categories.index',
'filament.admin.resources.product-categories.create','filament.admin.resources.product-categories.edit','filament.admin.resources.products.index','filament.admin.resources.products.create','filament.admin.resources.products.edit',
...
'filament.marketplace.pages.dashboard','cashier.payment','cashier.webhook','livewire.update','livewire.upload-file','livewire.preview-file','home',
...
'app','cashier::invoice','cashier::payment','filament-actions::badge-action','filament-actions::badge-group',
...
'filament-panels::widgets.account-widget','filament-panels::widgets.filament-info-widget','filament-shield::forms.shield-toggle','filament-tables::columns.checkbox-column','filament-tables::columns.color-column',
...
'validation.url','validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','filament-shield::filament-shield.column.name',
'filament-shield::filament-shield.column.guard_name','filament-shield::filament-shield.column.team','filament-shield::filament-shield.column.roles','filament-shield::filament-shield.column.permissions','filament-shield::filament-shield.column.updated_at',
'filament-shield::filament-shield.field.name','filament-shield::filament-shield.field.guard_name','filament-shield::filament-shield.field.permissions','filament-shield::filament-shield.field.team','filament-shield::filament-shield.field.team.placeholder',
'filament-shield::filament-shield.field.select_all.name','filament-shield::filament-shield.field.select_all.message','filament-shield::filament-shield.nav.group','filament-shield::filament-shield.nav.role.label','filament-shield::filament-shield.nav.role.icon',
'filament-shield::filament-shield.resource.label.role','filament-shield::filament-shield.resource.label.roles','filament-shield::filament-shield.section','filament-shield::filament-shield.resources','filament-shield::filament-shield.widgets',
'filament-shield::filament-shield.pages','filament-shield::filament-shield.custom','filament-shield::filament-shield.forbidden','filament-shield::filament-shield.resource_permission_prefixes_labels.view','filament-shield::filament-shield.resource_permission_prefixes_labels.view_any',
...
'DB_USERNAME','DB_PASSWORD','LOG_CHANNEL','LOG_STACK','LOG_DEPRECATIONS_CHANNEL',
'LOG_LEVEL','BROADCAST_CONNECTION','FILESYSTEM_DISK','QUEUE_CONNECTION','MAIL_MAILER',
'MAIL_SCHEME','MAIL_HOST','MAIL_PORT','MAIL_USERNAME','MAIL_PASSWORD',
'MAIL_FROM_ADDRESS','MAIL_FROM_NAME','MEMCACHED_HOST','REDIS_CLIENT','REDIS_HOST',
'REDIS_PASSWORD','REDIS_PORT','SESSION_DRIVER','SESSION_LIFETIME','SESSION_ENCRYPT',
'SESSION_PATH','SESSION_DOMAIN','STRIPE_KEY','STRIPE_SECRET','STRIPE_WEBHOOK_SECRET',
'PHP_CLI_SERVER_WORKERS','VITE_APP_NAME',);
