...
'filesystems.disks.s3.report','filesystems.links./Users/jonerickson/Code/mi/public/storage','inertia.ssr.enabled','inertia.ssr.url','inertia.ensure_pages_exist',
...
'services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.discord.client_id','services.discord.client_secret','services.discord.redirect',
'services.roblox.client_id','services.roblox.client_secret','services.roblox.redirect','services.workos.client_id','services.workos.secret',
'services.workos.redirect_url','session.driver','session.lifetime','session.expire_on_close','session.encrypt',
...
'session.same_site','session.partitioned','spark.path','spark.middleware','spark.prorates',
'spark.date_format','spark.features','spark.invoice_data.vendor','spark.invoice_data.product','spark.invoice_data.street',
'spark.invoice_data.location','spark.invoice_data.phone','spark.billables.user.model','spark.billables.user.trial_days','spark.billables.user.default_interval',
'spark.billables.user.plans','spark.brand.logo','spark.brand.color','hashing.driver','hashing.bcrypt.rounds',
...
'ide-helper.macroable_traits','tinker.commands','tinker.alias','tinker.dont_alias','vat_calculator.rules',
'vat_calculator.business_country_code','vat_calculator.forward_soap_faults','vat_calculator.soap_timeout','vat_calculator.hmrc.client_id','vat_calculator.hmrc.client_secret',);
...
'filament.admin.resources.topics.edit','filament.admin.resources.shield.roles.index','filament.admin.resources.shield.roles.create','filament.admin.resources.shield.roles.view','filament.admin.resources.shield.roles.edit',
'filament.marketplace.auth.logout','filament.marketplace.pages.dashboard','cashier.payment','cashier.webhook','spark.invoices.download','spark.portal',
'livewire.update','livewire.upload-file','livewire.preview-file','home','forums.index','forums.show','forums.topics.show',
'policies.index','policies.categories.show','policies.show','api.search','dashboard',
'blog.index','blog.show','blog.comments.store','forums.topics.create','forums.topics.store',
'forums.topics.reply','forums.topics.read','posts.like','comments.like',
'profile.edit','profile.update','profile.destroy','profile.billing','profile.invoices',
'profile.payment-methods','appearance','store.categories','store.products.view','store.subscriptions',
'register','login','password.request',
'password.email','password.reset','password.store','oauth.redirect','oauth.callback',
...
'cashier::invoice','cashier::payment','filament-actions::badge-action','filament-actions::badge-group','filament-actions::button-action',
...
'filament-panels::widgets.filament-info-widget','filament-shield::forms.shield-toggle','filament-tables::columns.checkbox-column','filament-tables::columns.color-column','filament-tables::columns.icon-column',
...
'filament::components.tabs.index','filament::components.tabs.item','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
...
'pagination::tailwind','spark::app','spark::mail.confirm_payment','spark::mail.invoice',);
