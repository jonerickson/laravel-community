...
'filament.admin.resources.api-tokens.edit','filament.admin.resources.forums.index','filament.admin.resources.forums.create','filament.admin.resources.forums.edit','filament.admin.resources.policy-categories.index',
'filament.admin.resources.policy-categories.create','filament.admin.resources.policy-categories.edit','filament.admin.resources.policies.index','filament.admin.resources.policies.create','filament.admin.resources.policies.edit',
'filament.admin.resources.posts.index','filament.admin.resources.posts.create','filament.admin.resources.posts.edit','filament.admin.resources.product-categories.index','filament.admin.resources.product-categories.create',
'filament.admin.resources.product-categories.edit','filament.admin.resources.products.index','filament.admin.resources.products.create','filament.admin.resources.products.edit','filament.admin.resources.topics.index',
'filament.admin.resources.topics.create','filament.admin.resources.topics.edit','filament.admin.resources.user-fingerprints.index','filament.admin.resources.users.index','filament.admin.resources.users.create',
'filament.admin.resources.users.edit','filament.admin.resources.shield.roles.index','filament.admin.resources.shield.roles.create','filament.admin.resources.shield.roles.view','filament.admin.resources.shield.roles.edit',
'filament.marketplace.auth.logout','filament.marketplace.pages.dashboard','cashier.payment','cashier.webhook','sanctum.csrf-cookie',
'livewire.update','livewire.upload-file','livewire.preview-file',
'fingerprint','search','home','banned',
'dashboard','posts.like','comments.like','register',
'login','password.request','password.email','password.reset',
'password.store','oauth.redirect','oauth.callback','verification.notice','verification.verify',
'verification.send','password.confirm','logout','blog.index',
'blog.show','blog.comments.store','forums.index','forums.show','forums.topics.show',
'forums.topics.create','forums.topics.store','forums.topics.reply','forums.topics.read','policies.index',
'policies.categories.show','policies.show','settings','settings.profile.edit','settings.profile.update',
'settings.profile.destroy','settings.appearance','settings.billing','settings.invoices','settings.payment-methods',
'store.index','store.categories.show','store.products.show','store.subscriptions','store.cart',
'store.cart.store','store.cart.update','store.cart.delete','store.cart.clear','store.cart.checkout',
'store.checkout.success','store.checkout.cancel','storage.local',);
