...
'filament.marketplace.auth.logout','filament.marketplace.pages.dashboard','cashier.payment','cashier.webhook','livewire.update','livewire.upload-file','livewire.preview-file',
'home','forums.index','forums.show','forums.topics.show','policies.index',
'policies.categories.show','policies.show','api.search','dashboard','blog.index',
...
'filament-panels::resources.relation-manager','filament-panels::widgets.account-widget','filament-panels::widgets.filament-info-widget','filament-shield::forms.shield-toggle','filament-tables::columns.checkbox-column',
