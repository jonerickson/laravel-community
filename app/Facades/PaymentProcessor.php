 ...
 * @method static \App\Data\SubscriptionData|string|bool startSubscription(\App\Models\Order $order, bool $chargeNow = true, bool $firstParty = true, string|null $successUrl = null)
 * @method static \App\Data\SubscriptionData|bool swapSubscription(\App\Models\Order $order, \App\Enums\ProrationBehavior $prorationBehavior = 'create_prorations', \App\Enums\PaymentBehavior $paymentBehavior = 'default_incomplete')
