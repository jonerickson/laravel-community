 ...
 * @method static \App\Data\SubscriptionData|string|bool startSubscription(\App\Models\Order $order, bool $chargeNow = true, bool $firstParty = true, \App\Enums\ProrationBehavior $prorationBehavior = 'create_prorations', \DateTimeInterface|int|null $backdateStartDate = null, \DateTimeInterface|int|null $anchorBillingCycle = null, string|null $successUrl = null)
 * @method static \App\Data\SubscriptionData|bool swapSubscription(\App\Models\User $user, \App\Models\Price $price, \App\Enums\ProrationBehavior $prorationBehavior = 'create_prorations', \App\Enums\PaymentBehavior $paymentBehavior = 'default_incomplete')
 ...
 * @method static mixed listSubscribers(\App\Models\Price|null $price = null)
