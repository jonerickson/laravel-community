 ...
 * @method static \App\Data\SubscriptionData|string|bool startSubscription(\App\Models\Order $order, bool $chargeNow = true, bool $firstParty = true, \App\Enums\ProrationBehavior $prorationBehavior = 'create_prorations', \Carbon\CarbonInterface|int|null $backdateStartDate = null, \Carbon\CarbonInterface|int|null $billingCycleAnchor = null, string|null $successUrl = null)
