                    ...
                    <div className="min-w-0 flex-1">
                        ...
                        <div
                            ...
                            className="prose prose-sm max-w-none
                                ...
                                [&_blockquote]:border-l-4 [&_blockquote]:pl-4 [&_blockquote]:italic [&_blockquote]:bg-muted [&_blockquote]:py-2 [&_blockquote]:text-muted-foreground [&_blockquote]:border-border [&_blockquote]:my-4
