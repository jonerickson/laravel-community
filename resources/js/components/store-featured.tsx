    ...
    return (
        <div>
            <div className="sm:flex sm:items-baseline sm:justify-between">
                <Heading title="Most popular" description="Our most popular products" />
            </div>
            ...
            <div className="grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:grid-rows-2 sm:gap-x-6 lg:gap-8">
                    ...
                    <div className="absolute inset-0 flex items-end p-6">
                        <div>
                            <h3 className="font-semibold text-white">
                                <Link href={route('store.products.view', { id: 2 })}>
                ...
                <div className="group relative aspect-[2/1] overflow-hidden rounded-lg sm:aspect-auto">
                    ...
                    <div className="absolute inset-0 flex items-end p-6">
                        <div>
                            <h3 className="font-semibold text-white">
                                <Link href={route('store.products.view', { id: 3 })}>
                                    <span className="absolute inset-0" />
                                    Accessories
                                </Link>
                            </h3>
                ...
                <div className="group relative aspect-[2/1] overflow-hidden rounded-lg sm:aspect-auto">
                    ...
                    <div className="absolute inset-0 flex items-end p-6">
                        <div>
                            <h3 className="font-semibold text-white">
                                <Link href={route('store.products.view', { id: 4 })}>
                                    <span className="absolute inset-0" />
                                    Workspace
                                </Link>
                            </h3>
