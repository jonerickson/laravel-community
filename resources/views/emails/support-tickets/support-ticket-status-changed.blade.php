<x-mail::message>
    # Support Ticket Status Updated Hello! The status of support ticket **{{ $supportTicket->ticket_number }}** has been updated. ## Ticket Details
    ...
    **Priority:** {{ $supportTicket->priority->getLabel() }}
    ...
    ## Status Change Summary Your support ticket has been moved from **{{ $oldStatus->getLabel() }}** to **{{ $newStatus->getLabel() }}**.
