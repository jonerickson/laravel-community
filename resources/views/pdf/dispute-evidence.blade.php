...
<body>
    ...
    <div class="section">
        ...
        @if (count($data->consents) > 0)
            ...
            <p style="font-size: 10px; color: #666; padding: 4px 10px;">
                The customer explicitly agreed to the above policies by performing a consent action (e.g., checkbox acceptance) at the timestamps shown.
            </p>
        @else
    ...
    <div class="disclaimer">
        ...
        <p>
            This document constitutes an official record of digital fulfillment generated by REACT Studios.
            The customer referenced in this document consented to the applicable Terms of Service prior to
            completing their purchase. By agreeing to these terms, the customer acknowledged the nature of
            digital goods delivery and waived the right of withdrawal upon successful fulfillment of the
            digital content. All timestamps are recorded at the time of the respective events and are
            maintained in our system of record.
        </p>
    </div>
</body>
</html>
